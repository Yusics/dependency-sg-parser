...
def read_region_graphs():
	return json.load(open("./all_region_graphs_%d.json" %NUM, "r"))
...
def generate_coco_split():
	train_id_path = '/media/Work_HD/yswang/dataset/glove/glove.6B/pre_region/train_id.p' 
	dev_id_path   = '/media/Work_HD/yswang/dataset/glove/glove.6B/pre_region/dev_id.p'
