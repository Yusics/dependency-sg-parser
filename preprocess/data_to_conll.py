...
parser = OptionParser()
parser.add_option("--input", dest="input_path", help="Required Processed input file", metavar="FILE", default="/media/Work_HD/yswang/dataset/visual_genome/preprocess/preprocess_json/pre_coco_train.json")
parser.add_option("--output", dest="output_path", help="Processed file output file path", metavar="FILE", default="coco_train.conll")
parser.add_option("--train", dest="isTrain", help="Check if processed file needed Training", default=True)
...
#datapath = "/media/Work_HD/yswang/dataset/glove/glove.6B/pre_region/train_coco_random_rg.json" 
#datapath = "/media/Work_HD/yswang/dataset/glove/glove.6B/pre_region/dev_coco_random_rg.json"
#datapath = "/media/Work_HD/yswang/dataset/glove/glove.6B/pre_region/test_coco_rg.json"
