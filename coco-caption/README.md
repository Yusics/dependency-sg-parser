...
- You will first need to download the pretrained weights for use by SPICE. To do this, run:
    ./get_pretrain_model.sh

- If you want to run Peter's Spice parser, first run ./get_stanford_models.sh. Then change ./coco-caption/pycocoevalcap/eval.py line 7 "from spice.spice import Spice" to "from spice_ori.spice import Spice"
